...
class BirdSuppliesAdapetr(
    var context: Context,
    val click: OnClickInterface

    ) : RecyclerView.Adapter<BirdSuppliesAdapetr.ExerciseHodlder>() {
...
/*
        ...
        if (position == 0) {
            ...
            holder.text.setText("Bird Food")

            Picasso.get()
                .load(R.drawable.pet_bird_1)
                .into(holder.image)
        ...
        if (position == 1) {
            ...
            holder.text.setText("Bird Cages")

            Picasso.get()
                .load(R.drawable.pet_bird_2)
                .into(holder.image)
        ...
        if (position == 2) {
            ...
            holder.text.setText("Bird Accessories")

            Picasso.get()
                .load(R.drawable.pet_bird_3)
                .into(holder.image)
        ...
        if (position == 3) {
            ...
            holder.text.setText("Bird Toys")

            Picasso.get()
                .load(R.drawable.pet_bird_4)
                .into(holder.image)
