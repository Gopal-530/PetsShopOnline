...
class RelatedSellerAdapter(
    var context: Context,

    ) : RecyclerView.Adapter<RelatedSellerAdapter.ExerciseHodlder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ExerciseHodlder {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.top_related_design, parent, false)
