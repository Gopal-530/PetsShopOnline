package com.petshop.online.Adapter.HomeAdapter
...
import com.petshop.online.ResponseApi.HomeResponce
import com.squareup.picasso.Picasso


class ExploreAdapter(
    var context: Context,
    var explorelist: ArrayList<HomeResponce.Explore>
    ) : RecyclerView.Adapter<ExploreAdapter.ExerciseHodlder>() {
...
/*
        ...
        holder.text.setText(explorelist[position].companyname)
        Picasso.get()
