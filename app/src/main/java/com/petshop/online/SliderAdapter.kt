...
class SliderAdapter( private var mContext: Context, sliderDataArrayList: ArrayList<SliderData>) :
    ...
    override fun onBindViewHolder(viewHolder: SliderAdapterViewHolder, position: Int) {
        ...
        if (position==0){
            Glide.with(mContext)
                .load(R.drawable.banner_01)
                .fitCenter()
                .into(viewHolder.imageViewBackground)
        }else if (position==1){
            Glide.with(mContext)
                .load(R.drawable.banner_02)
                .fitCenter()
                .into(viewHolder.imageViewBackground)
        }else if (position==2){
            Glide.with(mContext)
                .load(R.drawable.banner_03)
                .fitCenter()
                .into(viewHolder.imageViewBackground)
        }
